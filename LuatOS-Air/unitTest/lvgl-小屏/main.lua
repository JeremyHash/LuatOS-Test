...
-- 模式mode:common对应的普通版本和custom对应的定制版本
local mode = "common"
local count = 1
if mode == "custom" then
        ...
        while true do
            ...
            function event_handler(obj, event)
                if event == lvgl.EVENT_VALUE_CHANGED then
                    ...
                    if date then
                        ...
                        lvgl.calendar_set_highlighted_dates(obj, highlightDate,
                                                            1)
                    end
                end
            end
         ...
         Nuts]])
            ...
            lvgl.label_set_text(label,
                                "#0000ff Re-color# #ff00ff words# #ff0000 of\n# align the lines to\n the center and wrap\n long text automatically.")
            ...
            -- 添加样式
            lvgl.obj_add_style(demo_Gauge, lvgl.GAUGE_PART_MAIN,
                               demo_ThemeStyle_Bg)
            sys.wait(3000)
            ...
            -- 设置 Table 的位置
            lvgl.obj_align(demo_Table, DEMO_BASE_CONT, lvgl.ALIGN_CENTER, -50,
                           -50)
            -- 添加样式
            lvgl.obj_add_style(demo_Table, lvgl.TABLE_PART_BG,
                               demo_ThemeStyle_Bg)
            sys.wait(3000)
