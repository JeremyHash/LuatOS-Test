...
function fdbTest.test()
    ...
    assert(fdb.kv_set("testString", "LuatOS-SoC-Test") == true, tag .. ".kv_set ERROR")
    assert(fdb.kv_set("testTable", {
    ...
    assert(fdb.kv_get("testTable")["project"] == "LuatOS-SoC-Test", tag .. ".kv_get ERROR")
